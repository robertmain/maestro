(function(e) {
  if ("function" == typeof bootstrap) bootstrap("qr", e);
  else if ("object" == typeof exports) module.exports = e();
  else if ("function" == typeof define && define.amd) define(e);
  else if ("undefined" != typeof ses) {
    if (!ses.ok()) return;
    ses.makeQr = e
  } else "undefined" != typeof window ? window.qr = e() : global.qr = e()
})(function() {
  ...
  return (function(e, t, n) {
    ...
    1: [function(require, module, exports) {
      ...
      module.exports = function(text, opt) {
        ...
        return (opt.render === 'canvas') ? mk_canvas(qrcode, opt) : mk_table(qrcode, opt);
      };
      ...
      function mk_table(qrcode, opt) {
        ...
        for (var r = 0; r < cells.length; ++r) {
          ...
          for (var c = 0; c < row.length; ++c) {
            ...
            col_el.width = perc;
            col_el.style.backgroundColor = row[c] ? opt.foreground : opt.background;
    ...
    2: [function(require, module, exports) {
      ...
      var qrcode = function(data, opt) {
          opt = opt || {};
          var qr = new QRCode(opt.typeNumber || -1, opt.errorCorrectLevel || ErrorCorrectLevel.H);
          qr.addData(data);
          qr.make();
